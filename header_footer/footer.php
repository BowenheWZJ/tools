            ...
            <div class="row">
                ...
                <div class="col-xs-12 col-sm-6 col-md-3">
                    <div class="widget subscribe no-box">
                        <h5 class="widget-title">Webzilla<span></span></h5>
                        <p>Webzilla specializes in technological and IT-related services such as Web development, Database, SEO, E-commerce web development, Platform development, etc. </p>
                    </div>
                </div>
                ...
                <div class="col-xs-12 col-sm-6 col-md-3">
                    <div class="widget no-box">
                        ...
                        <ul class="thumbnail-widget">
                            <li>
                                <div class="thumb-content"><a href="https://webzilla.co.nz/">webzilla Home</a></div>
                            </li>
                            <li>
                                <div class="thumb-content"><a href="https://webzilla.co.nz/it-services/">IT service</a></div>
                            </li>
                            <li>
                                <div class="thumb-content"><a href="https://webzilla.co.nz/about-us/">About Us</a></div>
                            </li>
                            <li>
                                <div class="thumb-content"><a href="https://webzilla.co.nz/contact-us/">Contact Us</a></div>
                            </li>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-12 text-center">
                    <p>Copyright Webzilla © 2020. All rights reserved.</p>
                </div>
            </div>
        </div>
    </div>
